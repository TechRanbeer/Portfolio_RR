...
import { Send, User, Bot, Loader2, Info, Sparkles, Copy, Check, Terminal } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-6">
          <motion.div 
            ...
            className="p-8 bg-slate-900/40 border border-white/5 rounded-3xl backdrop-blur-sm"
          >
            <div className="flex items-center space-x-3 text-white font-black mb-6 uppercase tracking-tight">
            ...
            <ul className="space-y-4">
              {[
                { label: "Deep Project Context", desc: "Explains architecture and tech stacks in detail." },
                { label: "Engineering Mindset", desc: "Answers as Ranbeer using his first-person persona." },
                { label: "Quick Reference", desc: "Finds contact info, skills, and background instantly." }
              ].map((item, i) => (
                <li key={i} className="group">
                  <div className="text-sm font-bold text-slate-300 group-hover:text-cyan-400 transition-colors mb-1">{item.label}</div>
          ...
          <motion.div 
            ...
            className="p-8 bg-gradient-to-br from-cyan-900/10 to-transparent border border-cyan-500/10 rounded-3xl"
          >
            <div className="flex items-center space-x-3 text-white font-black mb-4 uppercase tracking-tight">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-cyan-400 font-mono">Gemini Flash-3</span>
              </div>
              <div className="flex justify-between items-center text-xs">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-slate-300 font-mono">1M Tokens</span>
              </div>
            </div>
          </motion.div>
        </div>
